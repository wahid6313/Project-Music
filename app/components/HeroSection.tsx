...
function HeroSection() {
  return (
    <div className="flex flex-col items-center justify-center relative h-full  w-full text-black  overflow-hidden max-auto py-10 md:py-0">
      ...
      <div className=" w-full text-center p-4  z-10 relative">
        ...
        <div className="mt-10 text-white  w-50 items-center">
          <Link href={"/music"}>
            <Button
